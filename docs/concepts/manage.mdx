...
This guide will walk through creating & managing actors.
...
<Tip>See the setup guide for your platform on how to access `/* CONNECTION ADDRESS */`.</Tip>
...
Read more about parameters & connections [here](/concepts/connections).
...
Read more about the [actor lifecycle](/concepts/lifecycle).
