...
| **RPC- & Event-Based Communication** | Actors communicate through asynchronous [RPCs](/concepts/remote-procedure-calls) or [events](/concepts/events), making it easy to distribute them across different machines.                                                                                                                                               |
...
- Use [RPCs](/concepts/remote-procedure-calls) to request data from other actors
