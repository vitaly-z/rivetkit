...
| **RPC- & Event-Based Communication** | Actors communicate through asynchronous [RPCs](/concepts/rpc) or [events](/concepts/events), making it easy to distribute them across different machines.                                                                                                                                               |
...
- Use [RPCs](/concepts/rpc) to request data from other actors
