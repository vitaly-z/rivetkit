...
<div class="code-group">
  ...
  <div class="code-group-disclaimer">
    We're working on publishing full examples related to these snippets. If you find an error, please <a href="https://github.com/rivet-gg/actor-core/issues" target="_blank" rel="noopener noreferrer">create an issue</a>.
  </div>
</div>
