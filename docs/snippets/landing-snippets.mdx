...
<div class="code-group">
  <div class="code-group-tabs">
    ...
    <div class="code-group-tab-row primary-tabs">
      <div class="code-group-tab-row-inner">
        ...
        <div class="code-group-tab active" data-tab="ai">
        ...
        <div class="code-group-tab" data-tab="chat">
  ...
  <div class="code-group-panels">
    {/* AI Agent */}
    <div class="code-panel active" data-panel="ai-memory">
    ...
    {/* Chat Room */}
    <div class="code-panel" data-panel="chat-memory">
      <div class="code-split">
        <div class="code-split-panel">
          <div class="code-panel-title">
            <span class="file-name">actor.ts</span>
