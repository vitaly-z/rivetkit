...
export function MultiplayerGame() {
  ...
  }, [worker, connectionId, players]);
  
  // Listen for world updates
  useWorkerEvent({ worker, event: "worldUpdate" }, ({ players: updatedPlayers }) => {
