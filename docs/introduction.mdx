...
<CardGroup cols={2}>
  <div>
    ...
    <p style={{ fontSize: "1.125rem" }}>
	  ...
	  Integrates with 
      <a class="no-break" href="/integrations/hono"><img class="inline-icon" src="/images/platforms/hono.svg" /> Hono</a> and 
      <a class="no-break" href="/drivers/redis"><img class="inline-icon" src="/images/platforms/redis.svg" /> Redis</a>.
    </p> 
...
<CardGroup cols={3}>
  <Card
    ...
    horizontal={true}
  />
  <Card title="RPC" href="/concepts/remote-procedure-calls" icon="code" horizontal={true} />
  <Card
    title="Events"
