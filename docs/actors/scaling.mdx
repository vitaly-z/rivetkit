...
| **Action- & Event-Based Communication** | Actors communicate through asynchronous [actions](/actors/actions) or [events](/actors/events), making it easy to distribute them across different machines.                                                                                                                                               |
...
- Use [actions](/actors/actions) to request data from other actors
