...
description: Learn how to call actions and connect to actors from client applications
...
<Tabs>
	...
	<Tab title="Actor-to-Actor">
		...
		Read more about [communicating between actors](/actors/communicating-between-actors).
	</Tab>
</Tabs>
