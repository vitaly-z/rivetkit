---
title: Registry
description: Configure and manage your actor registry
icon: list
---

The registry is the central configuration hub for your RivetKit application. It defines which actors are available and how your application runs.
